...
import cv2
import numpy as np
from capra_opi.image_processors.edge_detectors.EdgeDetector import EdgeDetector
from capra_opi.image_processors.edge_filters.EdgeFilter import EdgeFilter
from capra_opi.image_processors.shape_postprocessors.ShapePostProcessor import ShapePostProcessor
from capra_opi.lib.utils import compactRect
